...
**「你覺得 Siri、Google 小姐算不算有智慧？」** 大部分人的直覺反應可能是否定的——它們只是「看起來」很聰明。這正是人工智慧領域從一開始就在辯論的核心問題：我們該如何定義、又該如何判斷一台機器是否具備「智慧」？
...
> **課堂討論**：舉出生活中用過的 AI 應用（例如 Google 地圖導航、Netflix 推薦片單、手機拍照美肌），逐一討論這些應用屬於強 AI 還是弱 AI，藉此釐清「AI 很聰明」不等於「AI 有自我意識」。
...
從**有標籤（答案）**的資料中學習規則，然後對未知資料進行預測。就像考卷附有標準答案，可以直接對照學習。
...
生成式 AI 雖然強大，但絕對不是萬能，以下幾項限制值得花時間一一討論：
...
> **課堂討論**：想一想，掃地機器人、工廠裡的機械手臂、手術機器人，分別對應到上述五個組成部分中的哪些？藉此具體理解抽象定義。
...
這四個名詞常常被搞混，最適合的方式是畫一條「現實 → 虛擬」的光譜，看清楚彼此的相對位置：
...
量子電腦是這一章最抽象、也最容易讓人覺得「有點玄」的主題，可以先從一個生活化的思想實驗開始：**想像一枚旋轉中、還沒落地的硬幣——在它落地之前，你能不能說它「現在」是正面還是反面？**這正是量子力學中「疊加態」概念的生活版比喻。
...
**疊加態負責「讓運算量指數增長」，量子糾纏則負責「讓大量量子位元能夠協同運作」**，兩者合力賦予了量子電腦在特定問題上（例如新藥分子模擬、密碼破解、複雜最佳化問題）遠遠超越傳統電腦的潛力。不過也要澄清一個常見的迷思：量子電腦並不是「什麼問題都比傳統電腦快」，它在目前已知最擅長的，是傳統電腦計算上極度困難的特定類型問題，日常文書處理、上網瀏覽等一般任務，傳統電腦仍然又快又划算。
...
<details>
<summary>▶ 參考答案（開放性題目）</summary>

這是一題開放性題目，說出自己的觀察，以下提供一個可參考的完整論述方向：
