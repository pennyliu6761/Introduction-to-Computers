...
在正式介紹電腦之前，先想像一個情境：**如果你是三千年前的商人，要計算今天賣出多少匹布、收了多少銀兩，你會怎麼做？** 用手指頭數？在地上畫記號？這正是人類發明「計算工具」的起點——電腦的故事，其實就是一部「人類想辦法讓自己算得更快、更準、更省力」的歷史。
...
問題：**「你覺得一台沒有安裝任何軟體、也沒有連網路的電腦，開機之後能做什麼？」** 答案是：幾乎什麼都不能做。
...
> 「這是系統軟體還是應用軟體？」──「掃毒軟體」「LINE」「檔案總管」「小畫家」。**判斷關鍵句：這個軟體是在「管理電腦本身」，還是在「幫我完成一件具體的事」？**
...
**「你今天已經用過幾種電腦了？」** ——手機是電腦、智慧手錶是電腦、公車的到站系統是電腦、教室的冷氣搖控也可能內建電腦。電腦的分類，一般是依照**運算能力、體積大小、使用場景**來區分。
...
功能最強、執行速度最快的電腦，每秒鐘能夠執行數兆個運算。造價極為昂貴，通常只有國家級單位或大型機構才有能力使用，應用在需要極大量運算的領域，例如： **武器研發、天氣預測、生物實驗、新藥開發、航太科技、能源探勘、地質分析、天文研究** 。超級電腦不是「一台很貴的個人電腦」，而是把成千上萬個處理器連結起來協同運算的龐大系統。
...
4. 如果你是政府官員，要如何幫助偏鄉地區的孩子，享有和都市孩子一樣的資訊使用權？
